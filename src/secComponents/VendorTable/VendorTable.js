                            ...
                            <tbody>
                            {
                                this.state.currData.map(($data, $index) => {
                                    return ([<tr className="tableRow">
                                        ...
                                        <td className="custName" onClick={this.manuDetails.bind(this, $data.estimate, $index)}><span className="clr-primary">{$data.estimate.customer_name || '-'} <i className="float-right fas fa-info-circle"></i></span>{this.mDetails($data.line_item_id)}</td>
