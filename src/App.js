...
class App extends Component {
  ...
  componentDidMount() {
    ...
    ApiService.get( `/contacts/${ this.getContactId() }` ).then( res1 => {
      ...
      prefVendors
        ? StorageService.setItem( 'prefVendors', prefVendors )
        : ''
    } );
  }
    ...
    return ( <section className="content bom-tool manage" style={{
      ...
      <div className="inner">
          ...
          <div className="row">
            <div className="col-sm-4">
              <Button className="create-button">
                <Link to="/bom/new">Create a New BOM</Link>
              </Button>
            </div>
            ...
            <div className="col-sm-7">
              <div className="upload">
                <div className="bom-dropzone">
                  <Dropzone className="dropzone" ref={( node ) => ( this.dropZone = node )} onDrop={( acceptedFiles ) => {
                ...
                <div className="or-select-files">
                  <div>
                    <form method="post" action="" encType="multipart/form-data">
                      <input name="_authentication_token" type="hidden" value="211321901470595359153915695414268937302"/>
                      <input type="hidden" name="from_where" value="bom_manager"/>
                      <input type="file" id="datafile-1wjsS4rm" name="datafile" className="datafile" onChange={( e ) => this.loadFile( e.target.files )}/>
                ...
                <div className="upload-bom-button">
                  <div>
                    <form method="post" action="/bom-tool/upload" encType="multipart/form-data">
                      <input name="_authentication_token" type="hidden" value="211321901470595359153915695414268937302"/>
                      <input type="hidden" name="from_where" value="bom_manager"/>
                      <input type="file" id="datafile-4WfBYlCI" name="datafile" className="datafile"/>
        ...
        <div className="hint">
          ...
          <a href="/bom-tool/or-try-this-sample-bom">Try a sample BOM</a>
          or see the{' '}
